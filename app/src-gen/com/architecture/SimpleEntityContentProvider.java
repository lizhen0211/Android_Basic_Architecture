...
import com.architecture.biz.dao.SimpleEntityDao;

/* Copy this code snippet into your AndroidManifest.xml inside the <application> element:

    <provider
        android:name="com.architecture.SimpleEntityContentProvider"
        android:authorities="com.architecture.provider" />
*/

public class SimpleEntityContentProvider extends ContentProvider {

    public static final String AUTHORITY = "com.architecture.provider";
